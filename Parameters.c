...
void ReadConfiguration()
{
  ...
  input.open("/home/wiggert/Programs/k600analyserPR254/config.cfg");  //This is the line to change in order to change the configuration file
...
// 	      printf("Linebuffer: %s\n", LineBuffer.c_str());
    ...
    {
      if(ConfigRead)printf("Configuration file not found - you're going to crash. Oh the humanity!\n");
    }
