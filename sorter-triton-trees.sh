...
do
    ...
    if [ $item -lt 10 ]
    then
       FILE="/home/wiggert/Programs/k600analyserPR254/run0000"$item".mid.gz"
   elif [ $item -lt 100 ]
    then
       FILE="/home/wiggert/Programs/k600analyserPR254/run000"$item".mid.gz"
   elif [ $item -lt 1000 ]
    then
       FILE="/home/wiggert/Programs/k600analyserPR254/run00"$item".mid.gz"
   elif [ $item -lt 10000 ]
    then
       FILE="/home/wiggert/Programs/k600analyserPR254/run0"$item".mid.gz"
   else
