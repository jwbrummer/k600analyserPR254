...
double CalcThetaScat(double X1, double ThFP)
{
  ...
  // These Parameters are used to reproduce a thetaSCAT v X1pos spectrum with a plus/minus acceptance for a proper line-shape correction

  double *ThetaSCATPars = new double[6];
  ThetaSCATPars[0] = -0.494677;  
  ThetaSCATPars[1] = -0.000106; 
  ThetaSCATPars[2] =  0;   
  ThetaSCATPars[3] =  18.866;   
  ThetaSCATPars[4] = -0.000511; 
  ThetaSCATPars[5] =  0;  
