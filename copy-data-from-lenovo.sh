...
do
	...
	LOCATION="/home/wiggert/Desktop/mapping/unsorted/run0000"$item".mid.gz"
    elif [ $item -lt 100 ]
    then
	FILE="/media/wiggert/Lenovo/PR254/unsortedRuns/run000"$item".mid.gz"
	LOCATION="/home/wiggert/Desktop/mapping/unsorted/run000"$item".mid.gz"
    elif [ $item -lt 1000 ]
    then
	FILE="/media/wiggert/Lenovo/PR254/unsortedRuns/run00"$item".mid.gz"
	LOCATION="/home/wiggert/Desktop/mapping/unsorted/run00"$item".mid.gz"
    elif [ $item -lt 10000 ]
    then
	FILE="/media/wiggert/Lenovo/PR254/unsortedRuns/run0"$item".mid.gz"
	LOCATION="/home/wiggert/Desktop/mapping/unsorted/run0"$item".mid.gz"
    else
